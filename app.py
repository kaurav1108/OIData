...
Select 
	CASE
	WHEN (MAX(CASE WHEN instrumentType = 'CE' THEN round(`change`,3) END)) < 0 AND (MAX(CASE WHEN instrumentType = 'CE' THEN openInterest END)) < 0 THEN 'Long Liquidation'
    WHEN (MAX(CASE WHEN instrumentType = 'CE' THEN round(`change`,3) END)) < 0 AND (MAX(CASE WHEN instrumentType = 'CE' THEN openInterest END)) > 0 THEN 'Short Buildup'
    WHEN (MAX(CASE WHEN instrumentType = 'CE' THEN round(`change`,3) END)) > 0 AND (MAX(CASE WHEN instrumentType = 'CE' THEN openInterest END)) > 0 THEN 'Long Buildup'
    WHEN (MAX(CASE WHEN instrumentType = 'CE' THEN round(`change`,3) END)) > 0 AND (MAX(CASE WHEN instrumentType = 'CE' THEN openInterest END)) < 0 THEN 'Short covering'
    END AS 'CE_Signal',
  ...
  CASE
	WHEN (MAX(CASE WHEN instrumentType = 'PE' THEN round(`change`,3) END)) < 0 AND (MAX(CASE WHEN instrumentType = 'PE' THEN openInterest END)) < 0 THEN 'Long Liquidation'
    WHEN (MAX(CASE WHEN instrumentType = 'PE' THEN round(`change`,3) END)) < 0 AND (MAX(CASE WHEN instrumentType = 'PE' THEN openInterest END)) > 0 THEN 'Short Buildup'
    WHEN (MAX(CASE WHEN instrumentType = 'PE' THEN round(`change`,3) END)) > 0 AND (MAX(CASE WHEN instrumentType = 'PE' THEN openInterest END)) > 0 THEN 'Long Buildup'
    WHEN (MAX(CASE WHEN instrumentType = 'PE' THEN round(`change`,3) END)) > 0 AND (MAX(CASE WHEN instrumentType = 'PE' THEN openInterest END)) < 0 THEN 'Short covering'
    END AS 'PE_Signal'
...
cnx = mysql.connector.connect(user='test', password='2035',
...
def page1():
    ...
    return render_template('index.html', niftyunderlying=niftyunderlying, bniftyunderlying=bniftyunderlying, niftyoi=niftyoi, bniftyoi=bniftyoi, breakniftyoi=breakniftyoi, breakbniftyoi=breakbniftyoi)
